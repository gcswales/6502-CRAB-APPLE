...
# 10 "/opt/microchip/xc8/v2.36/pic/include/c99/ctype.h" 3
int isalnum(int);
int isalpha(int);
int isblank(int);
int iscntrl(int);
...
int tolower(int);
int toupper(int);
# 41 "/opt/microchip/xc8/v2.36/pic/include/c99/ctype.h" 3
# 1 "/opt/microchip/xc8/v2.36/pic/include/c99/bits/alltypes.h" 1 3
# 411 "/opt/microchip/xc8/v2.36/pic/include/c99/bits/alltypes.h" 3
typedef struct __locale_struct * locale_t;
# 42 "/opt/microchip/xc8/v2.36/pic/include/c99/ctype.h" 2 3
...
uint8_t getch( void )
{
 ...
 buff_count--;
 if( buff_count == 64 ) putch( 0x11 );
 return( buffer[ buff_out++ ] );
}
...
void __attribute__((picinterrupt(("irq(32),high_priority,base(8)")))) UART1_rx_vect_isr()
{
 buff_count++;
 buffer[ buff_in++ ] = (uint8_t)toupper(U1RXB);
 if( buff_count == 192 ) putch( 0x13 );
...
void __attribute__((picinterrupt(("irq(34),low_priority,base(8)")))) UART1_framing_err_vect_isr()
{
    U1ERRIR = 0;
 U1CON1bits.ON = 0;
 U1CON1bits.ON = 1;
