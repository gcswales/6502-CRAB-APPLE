...
void main(void)
{
 ...
 clc2_init();
 load_settings();
 uart1_init(eprom.settings.baud);
 (INTCON0bits.GIEH = 1);
 (INTCON0bits.GIEL = 1);
...
void reset_init(void)
{
 ...
 clock_set(eprom.settings.speed);
...
void load_settings(void)
{
 ...
 if(eprom.settings.ver!=11)
 {
  eprom.settings.ver=11;
  eprom.settings.colour=7;
  eprom.settings.baud=192;
  eprom.settings.speed=1;
  save_settings();
 }
}
